...
namespace DerCooleVonDem\EconomyLite\lib\poggit\libasynql;
...
use DerCooleVonDem\EconomyLite\lib\poggit\libasynql\base\DataConnectorImpl;
use DerCooleVonDem\EconomyLite\lib\poggit\libasynql\base\SqlThreadPool;
use DerCooleVonDem\EconomyLite\lib\poggit\libasynql\mysqli\MysqlCredentials;
use DerCooleVonDem\EconomyLite\lib\poggit\libasynql\mysqli\MysqliThread;
use DerCooleVonDem\EconomyLite\lib\poggit\libasynql\sqlite3\Sqlite3Thread;
...
final class libasynql{
	...
	public static function detectPackaged() : void{
		...
		if(!self::$packaged && defined("pocketmine\\VERSION")){
			Server::getInstance()->getLogger()->warning("Warning: Use of unshaded libasynql detected. Debug mode is enabled. This may lead to major performance drop. Please use a shaded package in production. See https://poggit.pmmp.io/virion for more information.\n");
		}
	}
